...
(function(factory) {
    ...
    "use strict";
    return function () {
        var PaddingOfDefaultCountry = 10;
        var length;
        ...
        var defaults = {
            ...
            preferredCountries: [], //preferredCountries: [ "us", "gb" ]
            ...
            _createClass(Iti, [ {
                ...
                key: "_setFlag",
                    value: function _setFlag(countryCode) {
                        ...
                        if (countryCode =='auto' || countryCode == undefined) {
                            this._updatePlaceholder(countryCode);
                            PaddingOfDefaultCountry = 0;
                            ...
                            //}
                            this.selectedFlagInner.setAttribute("class", "iti-flag auto");
                            ...
                            //    if (PaddingOfDefaultCountry == 10) {
                            //        

                            //        this.telInput.style.paddingLeft = "".concat(86, "px");
                            //        PaddingOfDefaultCountry = 0;
                            //    }
                            //    else {
                        ...
                        else
                        {
                            ...
                            if (this.options.separateDialCode) {
                                ...
                                if (PaddingOfDefaultCountry == 10) {
                                    ...
                                    if (this.telInput.placeholder == "Choose a Country") {
                                        
                                        if ($(window).width() < 400) {
                                            this.telInput.style.paddingLeft = "".concat(this.selectedFlag.offsetWidth + -146, "px");
                                        } else if ($(window).width() < 768) {
                                            this.telInput.style.paddingLeft = "".concat(this.selectedFlag.offsetWidth + -170, "px");
                                        } else {
                                            this.telInput.style.paddingLeft = "".concat(this.selectedFlag.offsetWidth + -210, "px");
                                        }
                                    }
                                    else {
                                        
                                        this.telInput.style.paddingLeft = "".concat(this.selectedFlag.offsetWidth - 190, "px");
                                    }
                ...
                key: "_updatePlaceholder",
                    value: function _updatePlaceholder(CountryCode) {
                ...
                {
                    key: "_getFullNumberCustom",
                    value: function _getFullNumberCustom() {
                        var val = this.telInput.value.trim();
                        var dialCode = "44";
                        var prefix;
                        var numericVal = this._getNumeric(val);
                ...
                value: function getNumber(format) {
                    ...
                    key: "getNumberCustom",
                    value: function getNumberCustom(format) {
                        if (window.intlTelInputUtils) {
                            var numebr = this._getFullNumberCustom();
                            //return numebr;
                            return intlTelInputUtils.formatNumber(this._getFullNumberCustom(), 'gb');
                        }
                        return "";
                    }
                },
                ...
                value: function isValidNumber() {
                    ...
                    key: "isValidNumberCustom",
                    value: function isValidNumberCustom() {
                 
                        var val = this._getFullNumberCustom().trim();
                        var countryCode = "gb";
                        return window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(val, countryCode) : null;
                    }
                },
        ...
        $("#phone").on('keypress focus',function (e) {
            var length1 = this.value.length;
            var initialplaceholder = $(this).attr('placeholder');
            if (initialplaceholder == "Choose a Country") {
                e.preventDefault();
                $(this).blur();
