...
namespace Umbraco.Web.PublishedContentModels
{
	...
	[PublishedContentModel("testNestedDoc")]
	public partial class TestNestedDoc : PublishedContentModel, IMetaProperties
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "testNestedDoc";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public TestNestedDoc(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<TestNestedDoc, TValue>> selector)
		{
		...
		/// FoldContainer
		///</summary>
		[ImplementPropertyType("foldContainer")]
		public IEnumerable<IPublishedContent> FoldContainer
		{
			get { return this.GetPropertyValue<IEnumerable<IPublishedContent>>("foldContainer"); }
		}
